...
MOCKABLE_FUNCTION(, PLAYER_MGR_HANDLE, manual_player_create, GAME_INFO*, game_info, BOARD_CELL, player_type);
...
MOCKABLE_FUNCTION(, void, manual_process_click, PLAYER_MGR_HANDLE, player_handle, const ROW_COL_INFO*, rc_info);
