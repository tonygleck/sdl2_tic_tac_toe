...
function(addCompileSettings theTarget)
    if (MSVC)
        ...
        target_compile_options(${theTarget} PRIVATE -Wall -Werror -Wextra -Wshadow -Wno-unused-function -fPIC -Wformat
            -Wformat-overflow -Wformat-truncation -fno-common)

        if (${DEBUG_CONFIG})
            target_compile_options(${theTarget} PRIVATE -O0)
        else()
            target_compile_options(${theTarget} PRIVATE -O3 -Os)
        endif()
    endif()
endfunction()
